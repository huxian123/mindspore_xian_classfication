...
def parse_arguments():
    ...
    parser.add_argument("--clip_global_norm", default=True, type=ast.literal_eval, help="clip global norm")
    ...
    parser.add_argument("--is_dynamic_loss_scale", default=True, type=int, help="is_dynamic_loss_scale ")
    parser.add_argument("--keep_checkpoint_max", default=50, type=int, help="keep checkpoint max num")
    parser.add_argument("--optimizer", help="Which optimizer to use", default="rmsprop")
    ...
    parser.add_argument("--warmup_length", default=1, type=int, help="Number of warmup iterations")
    parser.add_argument("--warmup_lr", default=0, type=float, help="warm up learning rate")
    ...
    parser.add_argument("--decay", default=0.9, type=float, metavar="W",
                        help="decay (default: 0.9)", dest="decay")
    parser.add_argument("--loss_scale", default=1024, type=int, help="loss_scale")
    parser.add_argument("--base_lr", "--learning_rate", default=1e-3, type=float, help="initial lr", dest="base_lr")
    parser.add_argument("--lr_scheduler", default="constant_lr", help="Schedule for the learning rate.")
    ...
    parser.add_argument("--pretrained", dest="pretrained", default='./efficientnets_imagenet22k.ckpt', type=str, help="use pre-trained model")
    ...
    parser.add_argument("--drop_out_rate", type=float, help="drop_out_rate", default=0.000001)
